...
<div class="pd-20">
	<form action="${ctx }/sys/org/toadd" method="post" class="form form-horizontal" id="form-user-character-add">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>组织编码：</label>
			<div class="formControls col-5">
				<input type="text" name="orgCode" class="input-text" value="" placeholder="admin" id="user-name" name="user-name" datatype="*4-16" nullmsg="用户账户不能为空">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>组织简称：</label>
			<div class="formControls col-5">
				<input type="text" name="simpleName" class="input-text" value="" placeholder="" id="user-name" name="user-name" datatype="*4-16" nullmsg="用户账户不能为空">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>组织全称：</label>
			<div class="formControls col-5">
				<input type="text" name="fullName" class="input-text" value="" placeholder="" id="user-name" name="user-name" datatype="*4-16" nullmsg="用户账户不能为空">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>部门简介：</label>
			<div class="formControls col-5">
				<textarea class="textarea" name="introduce" rows="5" cols="50"></textarea>
			</div>
		</div>
		<div class="row cl">
