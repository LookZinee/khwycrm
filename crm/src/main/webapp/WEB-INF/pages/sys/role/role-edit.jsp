	...
	<form action="${ctx }/sys/role/edit" method="post" class="form form-horizontal" id="form-user-character-add">
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" name="roleCode" class="input-text" value="${role.roleCode }" placeholder="admin" id="user-name" name="user-name" datatype="*4-16" nullmsg="用户账户不能为空">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>角色名称：</label>
			<div class="formControls col-5">
				<input type="text" name="roleName" class="input-text" value="${role.roleName }" placeholder="" id="user-name" name="user-name" datatype="*4-16" nullmsg="用户账户不能为空">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<textarea class="textarea" name="remark" rows="5" cols="50">${role.remark }</textarea>
			</div>
		</div>
		<div class="row cl">
			<div class="col-10 col-offset-2">
				<button type="submit" class="btn btn-primary radius" id="admin-role-save" name="admin-role-save"><i class="icon-ok"></i>确认修改</button>
